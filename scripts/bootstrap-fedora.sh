...
echo "Removing superseded Fedora 43 archive (if any)..."
rm -f "${CACHE_DIR}/sysopkit-test-fedora-43.tar"

echo "Removing image from local store..."
podman rmi "${FULL_IMAGE_NAME}" "fedora-minimal:${FEDORA_VERSION}" 2>/dev/null || true
